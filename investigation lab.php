...
<html>
    ...
    <body>
        ...
        <div class="investigation_header">
       <div class="overlay">
                <ul class="bxslider">
                  <li>
                    <h2>Welcome

                        <label for="investigation lab name"></label>
  <input type="text" name="investigation_name" id="investigation" value="">
