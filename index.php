...
<html>
    ...
    <body>
               ...
               <li><a href="#" data-value="ser">Services</a></li>
                 <li>
                     <div class="dropdown">
                      ...
                      <a href="#" data-value="med_org">Medical organizations</a>
       ...
       <div class="overlay">
                <ul class="bxslider">
                  <li>
                    <h2>Welcome to <span>INSURANCY</span></h2>
        ...
        <!-- Start Medical Org -->
       <div id="med_org" class="med_org">
        <div class="container">
          <h2 class="med-heading"> Medical Organizations</h2>
           <ul>
            <li class="selected">All</li>
            <li>Hospitals</li>
            <li>Pharmacies</li>
            <li>Investigation Labs</li>
            <li>Ray Labs</li>
...
<div class="gallery">
         ...
         <div>
                     ...
                     <img src="images/hospitals/andulsia.jpg">
        </div>
         <div>
                     <img src="images/investigation labs/alfa.jpg">
                    </div>
        <div>
                      <img src="images/ray labs/DarELAshaa.jpg">
        </div>
                    ...
                    <div class="row">
         <div>
                      <img src="images/hospitals/mbrt%20el%20asafra.jpg">
         </div>
         <div>
                      <img src="images/investigation%20labs/alburg.jpg">
       </div>
       <div>
                      <img src="images/ray%20labs/firstscan.jpeg">
       </div>
